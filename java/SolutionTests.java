...
public class SolutionTests {
    ...
    static String SOLUTIONSCLASS = "solutions.others.LeetCode"+"169";
    public static void main(String[] args) throws Exception{
        ...
        ListNode head = LinkedListFactory.getLinkedListFromIntegerArray(new int[]{1,2,3,4,5});

        String s = "abcaaaad";
        String p = "ab.a*d";
//        int root = 4;
        // 第一个参数转成Object，第二个参数转Object...
        Object[] item = { new int[] {3,3,4} };
        Object[] suite = {item};
